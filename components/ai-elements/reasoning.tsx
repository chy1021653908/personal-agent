...
export const ReasoningTrigger = memo(
  ({
    ...
    const t = useTranslations("common.reasoning");
    ...
    const defaultGetThinkingMessage = useCallback(
      (streaming: boolean, thinkingDuration?: number) => {
        ...
        if (thinkingDuration === undefined) {
          return <p>{t("fewSeconds")}</p>;
        }
        return <p>{t("seconds", { duration: thinkingDuration })}</p>;
      },
      [t]
    );
...
export const ReasoningContent = memo(
  function ReasoningContentInner({ className, children, ...props }: ReasoningContentProps) {
